...
var _user$project$Main$formatTimer = function (state) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		A2(
			_krisajenkins$formatting$Formatting$print,
...
var _user$project$Main$startGame = function () {
	...
	if (_p1.ctor === '[]') {
		...
		return {
			...
			current: _p1._0,
			input: '',
			timer: {currentTime: 0, timeAtStartOfThisAssociation: 0}
		};
	}
}();
var _user$project$Main$unsafeNonemptyList = function (l) {
	...
	if (_p3.ctor === '[]') {
		...
		var _p5 = _mgold$elm_nonempty_list$List_Nonempty$fromList(l);
		if (_p5.ctor === 'Nothing') {
			return _elm_lang$core$Native_Utils.crashCase(
				'Main',
				{
					start: {line: 112, column: 14},
...
var _user$project$Main$nonEmptyRandomListOfInts = A2(
	_elm_lang$core$Random$map,
	_user$project$Main$unsafeNonemptyList,
	A2(
...
var _user$project$Main$AssociationWithTime = F2(
	function (a, b) {
		return {association: a, duration: b};
	});
var _user$project$Main$Timer = F2(
	function (a, b) {
		return {currentTime: a, timeAtStartOfThisAssociation: b};
	});
...
var _user$project$Main$generateInitialModelFromRandomListOfInts = function (rands) {
	var zips = A3(
		_mgold$elm_nonempty_list$List_Nonempty$map2,
		F2(
			function (v0, v1) {
				return {ctor: '_Tuple2', _0: v0, _1: v1};
			}),
		_user$project$Associations$allAssociations,
		rands);
	var sorted = A2(_mgold$elm_nonempty_list$List_Nonempty$sortBy, _elm_lang$core$Basics$snd, zips);
	var allAssociationsInRandomOrder = A2(_mgold$elm_nonempty_list$List_Nonempty$map, _elm_lang$core$Basics$fst, sorted);
	return _user$project$Main$Running(
		{
			current: _mgold$elm_nonempty_list$List_Nonempty$head(allAssociationsInRandomOrder),
			done: _elm_lang$core$Native_List.fromArray(
				[]),
			input: '',
			left: _mgold$elm_nonempty_list$List_Nonempty$tail(allAssociationsInRandomOrder),
			timer: {currentTime: 0, timeAtStartOfThisAssociation: 0}
		});
};
var _user$project$Main$randomModel = A2(_elm_lang$core$Random$map, _user$project$Main$generateInitialModelFromRandomListOfInts, _user$project$Main$nonEmptyRandomListOfInts);
...
var _user$project$Main$getInitialState = A2(
	_elm_lang$core$Random$generate,
	function (ns) {
		return _user$project$Main$InitialState(
			_user$project$Main$generateInitialModelFromRandomListOfInts(ns));
	},
											...
											_elm_lang$core$Native_Utils.update(
												_p9,
												{
													...
													left: _p8._1,
														...
														_elm_lang$core$List_ops['::'],
														{association: _p9.current, duration: _p9.timer.currentTime - _p9.timer.timeAtStartOfThisAssociation},
														_p9.done),
													timer: {currentTime: _p9.timer.currentTime, timeAtStartOfThisAssociation: _p9.timer.currentTime}
												})),
										_1: _elm_lang$core$Platform_Cmd$none
									};
								}
...
var _user$project$Main$keyboard = function (x) {
	...
	switch (_p12) {
		...
		default:
			var ch = _elm_lang$core$Char$fromCode(_p12);
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('info running')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(state.current.number)
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$value(state.input)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$Main$formatTimer(state))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('associations-left')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(
						A2(
							...
							_elm_lang$core$Basics$toString(
								_elm_lang$core$List$length(state.left)),
							' jäljellä'))
					])),
				A2(
				_elm_lang$html$Html$div,
...
var _user$project$Main$viewDiv = F4(
	function (state, statusText, inputValue, statusClass) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
...
var _user$project$Main$viewInitial = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$class('info initial')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Paina välilyöntiä aloittaaksesi')
				])),
			A2(
			_elm_lang$html$Html$input,
			_elm_lang$core$Native_List.fromArray(
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(_elm_lang$core$Time$every, 40 * _elm_lang$core$Time$millisecond, _user$project$Main$Tick)
			]));
};
